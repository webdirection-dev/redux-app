        ...
        <div className="counter">
            <div className="counter__item">
                <div className="counter__display">
                    <h1 className="counter__count">{counter}</h1>
                </div>
                <div className="counter__btns">
                    <button onClick={inc} className="inc btn btn-success">
                    ...
                    <button onClick={dec} className="dec btn btn-danger">
                    ...
                    <button onClick={rnd} className="rnd btn btn-primary">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
...
// Передать значения state в ПРОПСЫ
...
// Передаем экшены или диспатчим функции в ПРОПСы

// 1. Короткий вариант mapDispatchToProps в ES6
// const mapDispatchToProps = (dispatch) => {
//     return  bindActionCreators( actions, dispatch );
// };

// 2. Развернутый вариант mapDispatchToProps
const mapDispatchToProps = (dispatch) => {
    ...
    return {
        inc: inc, // синтаксис ES5
        dec, // синтаксис ES6. По ES5 это dec: dec
        rnd // синтаксис ES6. По ES5 это rnd: rnd
    }
};
